...
Main_SetPlayerDefaultSpawn(playerid) {
	if (playerData[playerid][pSpawnPoint] == 2) {
		SetPlayerPos(playerid, 1642.9159,-2333.0674,13.5469);
		...
		SetPlayerPos(playerid, 2189.5234, -1203.6517, 1049.0234);
		SetPlayerFacingAngle(playerid, 267.0031);
		SetPlayerInterior(playerid, 6);
		SetPlayerVirtualWorld(playerid, 2001);
		playerData[playerid][pInterior] = 6;
		playerData[playerid][pVWorld] = 2001;	
	}
}
